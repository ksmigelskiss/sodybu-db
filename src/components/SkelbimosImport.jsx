...
export default function SkelbimosImport({ onSave, onCancel, onPickOnMap, mobile, initialUrl = '', initialText = '', initialExtracted = null }) {
  ...
  const handleSave = async () => {
    ...
    await onSave({
      ...
      zonaPavadinimas: pavadinimas || null,
        ...
        {isPreview && extracted && (
          <>
            ...
            <div style={{ padding: '12px 16px', display: 'flex', flexDirection: 'column', gap: 10, overflowY: 'auto', flex: 1 }}>
              ...
              {/* Sticky save footer */}
              <div style={{ position: 'sticky', bottom: 0, background: 'white', borderTop: '1px solid #f1f3f4', padding: '12px 16px', display: 'flex', gap: 8, marginTop: 8 }}>
